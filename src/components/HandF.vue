            ...
            <div id="navbarHeader" class="navbar-menu">
                ...
                <div class="navbar-end">
                    <div class="navbar-item">
                            <div v-if="userToken">
                                <router-link to="/stats" class="button is-light mx-3" v-on:click="removeNav()">Statistics</router-link>
                                <router-link to="/builderPage" class="button is-light mx-3" v-on:click="addNav()">Builder Page</router-link>
